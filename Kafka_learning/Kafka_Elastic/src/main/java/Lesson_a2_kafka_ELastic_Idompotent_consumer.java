...
public class Lesson_a2_kafka_ELastic_Idompotent_consumer {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while(true)
        {
            ...
            for(ConsumerRecord<String,String> record : records)   //Record not Records
            {
                ...
                //Create Id here so records if they are process twice they have same Id and hence not duplicated

                //Method 1 Simple
                //String id=record.topic()+"_"+record.partition()+"_"+record.offset();

                //Method 2 use the id from the record
                String id=extractIDFromTwitterRecorcd(record.value());

                IndexRequest ir=new IndexRequest("twitter","Tweets"
